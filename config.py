...
URLS_LICENCA_POR_PERFIL = {
    "ADMIN": URL_LICENCA_ADMIN,
    "SUPERVISAO": URL_LICENCA_SUPERVISAO,
    "TECNICO": URL_LICENCA_TECNICO,
    "USUARIO": URL_LICENCA_SUPERVISAO,
}
...
LICENCA_CACHE_PATH = os.path.join(
    os.path.expanduser("~"),
    f".rpa_search_data_licenca_{APP_PROFILE.lower()}.json"
)
